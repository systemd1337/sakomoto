<?php
//Example config file for a "/i/ - Oekaki" board
...
const HERE="http://mysite.tld/i/"; //URL link to this board
...
/* Meta */
const KEYWORDS = "anonymous,imageboard,image,board,chan,forum,oekaki,art,drawing,creativity";
const DESCRIPTION = "&quot;/i/ - Oekaki&quot; A board for creativity and artistry";
const TITLE = "/i/ - Oekaki"; //Name of this imageboard
...
const BUMPLIMIT = 150; //Maximum topic bumps
